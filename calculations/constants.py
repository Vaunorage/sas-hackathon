...
ACCOUNT_IDX_AJUSTEMENT_MENSUEL_GAR = 45
ACCOUNT_IDX_PC_GAR_DECES_2 = 46
ACCOUNT_IDX_AGE_CHANG_DECES = 47
ACCOUNT_IDX_FREQ_RESET_DECES = 48
ACCOUNT_IDX_MAX_RESET_DECES = 49
ACCOUNT_IDX_I_RESET_DECES_ECH = 50
ACCOUNT_IDX_NB_AN_ECH = 51
ACCOUNT_IDX_PC_RENOUV_ECH = 52
ACCOUNT_IDX_AGE_MAX_RENOUV_ECH = 53
ACCOUNT_IDX_MAX_RESET_FACUL_ECH = 54
ACCOUNT_IDX_RATIO_VM_VG_RESET_ECH = 55
ACCOUNT_IDX_AGE_MRV_PERMIS = 56
ACCOUNT_IDX_PC_BONI_SRG = 57
ACCOUNT_IDX_FREQ_RESET_SRG = 58
ACCOUNT_IDX_MAX_RESET_SRG = 59
ACCOUNT_IDX_TABLE_TAUX_MRV_MRG_MRA = 60
ACCOUNT_IDX_MT_TPA_RETRAIT = 61
ACCOUNT_IDX_M_MT_MRV_EXCEDENT = 62
ACCOUNT_IDX_MT_TPA_DEPOT = 63
ACCOUNT_IDX_VAR_RETRAIT_FCT = 64
ACCOUNT_IDX_PC_RETRAIT_AGE = 65
ACCOUNT_IDX_MT_RETRAIT_MAX = 66
ACCOUNT_IDX_I_RESET_FACUL_ECH = 67

# Total number of fields
ACCOUNT_IDX_TOTAL_FIELDS = 68
...
STATE_IDX_MT_BCB = 12
STATE_IDX_MT_MRV_MRG_MRA = 13
STATE_IDX_TAUX_MRV_MRG_MRA = 14
STATE_IDX_ANNEE_ECH = 15
STATE_IDX_MOIS_ECH = 16
STATE_IDX_TX_ACTUALISATION = 17
STATE_IDX_ANNEE_REELLE = 18
STATE_IDX_MOIS_EVAL = 19
STATE_IDX_PC_GAR_DECES_1 = 20
STATE_IDX_SIZE = 21  # Total number of state variables
...
# =============================================================================
# Cashflow components (non-discounted)
...
# Present value (VP) cashflow components - matching SAS output
FLUX_COMP_IDX_VP_PRIMES_GARANTIES = 18
FLUX_COMP_IDX_VP_PREST_DECES = 19
FLUX_COMP_IDX_VP_PREST_ECH = 20
FLUX_COMP_IDX_VP_PREST_MRV = 21
FLUX_COMP_IDX_VP_FRAIS_ACQUIS = 22
FLUX_COMP_IDX_VP_COMM_VENTE = 23
FLUX_COMP_IDX_VP_PRIMES_VARIABLES = 24
FLUX_COMP_IDX_VP_FRAIS_FIXES = 25
FLUX_COMP_IDX_VP_HON_GEST = 26
FLUX_COMP_IDX_VP_COMM_MAINTIEN = 27
FLUX_COMP_IDX_VP_VALEUR_MARCHANDE = 28
FLUX_COMP_IDX_VP_PASSIF_REDRESSE = 29
FLUX_COMP_IDX_VP_COUSSIN_CREDIT = 30
FLUX_COMP_IDX_VP_COUSSIN_MARCHE = 31
FLUX_COMP_IDX_VP_COUSSIN_DEPENSE = 32
FLUX_COMP_IDX_VP_COUSSIN_DECHEANCE = 33
FLUX_COMP_IDX_VP_COUSSIN_MORTALITE = 34
FLUX_COMP_IDX_VP_COUSSIN_DEPOT = 35
# Additional SAS output variables
FLUX_COMP_IDX_UNITE_COUVERTURE = 36
FLUX_COMP_IDX_DEPOT_FUTUR_SURVIE = 37
FLUX_COMP_IDX_REM_COMP_INV = 38
FLUX_COMP_IDX_VALEUR_GARANTIE = 39
FLUX_COMP_IDX_VP_FLUX_TOT = 40
# Detailed calculation fields
FLUX_COMP_IDX_MT_VM = 41
FLUX_COMP_IDX_MT_VM_AV_RETRAIT = 42
FLUX_COMP_IDX_MT_VM_AP_RETRAIT = 43
FLUX_COMP_IDX_AGE = 44
FLUX_COMP_IDX_QX = 45
FLUX_COMP_IDX_LAPSE_TOT = 46
FLUX_COMP_IDX_LAPSE_PART = 47
FLUX_COMP_IDX_TX_SURVIE = 48
FLUX_COMP_IDX_RETRAIT = 49
FLUX_COMP_IDX_DEPOT_FUTUR = 50
FLUX_COMP_IDX_MT_GAR_DECES = 51
FLUX_COMP_IDX_MT_GAR_ECH = 52
FLUX_COMP_IDX_MT_SRG = 53
FLUX_COMP_IDX_REND_SP500 = 54
FLUX_COMP_IDX_REND_TSX = 55
FLUX_COMP_IDX_REND_EAFE = 56
FLUX_COMP_IDX_REND_DEX = 57
FLUX_COMP_IDX_REND_MM = 58
FLUX_COMP_IDX_MT_SP500 = 59
FLUX_COMP_IDX_MT_TSX = 60
FLUX_COMP_IDX_MT_EAFE = 61
FLUX_COMP_IDX_MT_DEX = 62
FLUX_COMP_IDX_MT_MM = 63
FLUX_COMP_IDX_CAT_COUSSIN_1 = 64
FLUX_COMP_IDX_CAT_COUSSIN_2 = 65
FLUX_COMP_IDX_TX_ACTUALISATION = 66
FLUX_COMP_IDX_SIZE = 67

# =============================================================================
# CASHFLOW OUTPUT TENSOR INDICES (for standard output, not debug)
# Matches SAS CALCULS_SOMMAIRE output structure
# =============================================================================
# Non-discounted cashflows
CF_OUT_IDX_FRAIS_ACQUIS = 0
CF_OUT_IDX_COMM_VENTE = 1
CF_OUT_IDX_PRIMES_GARANTIES = 2
CF_OUT_IDX_PRIMES_VARIABLES = 3
CF_OUT_IDX_FRAIS_FIXES = 4
CF_OUT_IDX_HON_GEST = 5
CF_OUT_IDX_COMM_MAINTIEN = 6
CF_OUT_IDX_PREST_ECH = 7
CF_OUT_IDX_PREST_MRV = 8
CF_OUT_IDX_PREST_DECES = 9
# Present value cashflows
CF_OUT_IDX_VP_FRAIS_ACQUIS = 10
CF_OUT_IDX_VP_COMM_VENTE = 11
CF_OUT_IDX_VP_PRIMES_GARANTIES = 12
CF_OUT_IDX_VP_PRIMES_VARIABLES = 13
CF_OUT_IDX_VP_FRAIS_FIXES = 14
CF_OUT_IDX_VP_HON_GEST = 15
CF_OUT_IDX_VP_COMM_MAINTIEN = 16
CF_OUT_IDX_VP_PREST_ECH = 17
CF_OUT_IDX_VP_PREST_MRV = 18
CF_OUT_IDX_VP_PREST_DECES = 19
CF_OUT_IDX_VP_VALEUR_MARCHANDE = 20
# Coverage and values
CF_OUT_IDX_UNITE_COUVERTURE = 21
CF_OUT_IDX_DEPOT_FUTUR = 22
CF_OUT_IDX_REM_COMP_INV = 23
CF_OUT_IDX_VALEUR_MARCHANDE = 24
CF_OUT_IDX_VALEUR_GARANTIE = 25
CF_OUT_IDX_DEPOT_FUTUR_SURVIE = 26
# Cushions (non-discounted)
CF_OUT_IDX_PASSIF_REDRESSE = 27
CF_OUT_IDX_COUSSIN_CREDIT = 28
CF_OUT_IDX_COUSSIN_MARCHE = 29
CF_OUT_IDX_COUSSIN_DEPENSE = 30
CF_OUT_IDX_COUSSIN_DECHEANCE = 31
CF_OUT_IDX_COUSSIN_MORTALITE = 32
CF_OUT_IDX_COUSSIN_DEPOT = 33
# Cushions (present value)
CF_OUT_IDX_VP_PASSIF_REDRESSE = 34
CF_OUT_IDX_VP_COUSSIN_CREDIT = 35
CF_OUT_IDX_VP_COUSSIN_MARCHE = 36
CF_OUT_IDX_VP_COUSSIN_DEPENSE = 37
CF_OUT_IDX_VP_COUSSIN_DECHEANCE = 38
CF_OUT_IDX_VP_COUSSIN_MORTALITE = 39
CF_OUT_IDX_VP_COUSSIN_DEPOT = 40
# Total size
CF_OUT_IDX_SIZE = 41
